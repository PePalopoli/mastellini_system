...
$app['converter.banner_type'] = $app->share(function (Silex\Application $app) {
    return new Audi\AudiSystem\Service\BannerTypeConverter($app);
});
...
$app['converter.institutional_type'] = $app->share(function (Silex\Application $app) {
    return new Audi\AudiSystem\Service\InstitutionalTypeConverter($app);
});
...
// Exames Type
$security->match('exames', 'Security\ExamesType::index')->method('GET|POST')->bind('s_exames_type');
$security->match('exames/create', 'Security\ExamesType::create')->method('GET|POST')->bind('s_exames_type_create');
$security->match('exames/edit/{id}', 'Security\ExamesType::edit')->method('GET|POST')->bind('s_exames_type_edit');
$security->delete('exames/delete/{id}', 'Security\ExamesType::delete')->bind('s_exames_type_delete');

// Unidades Type
$security->match('unidades', 'Security\UnidadesType::index')->method('GET|POST')->bind('s_unidades_type');
$security->match('unidades/create', 'Security\UnidadesType::create')->method('GET|POST')->bind('s_unidades_type_create');
$security->match('unidades/edit/{id}', 'Security\UnidadesType::edit')->method('GET|POST')->bind('s_unidades_type_edit');
$security->delete('unidades/delete/{id}', 'Security\UnidadesType::delete')->bind('s_unidades_type_delete');

// Vagas Type
$security->match('vagas', 'Security\VagasType::index')->method('GET|POST')->bind('s_vagas_type');
$security->match('vagas/create', 'Security\VagasType::create')->method('GET|POST')->bind('s_vagas_type_create');
$security->match('vagas/edit/{id}', 'Security\VagasType::edit')->method('GET|POST')->bind('s_vagas_type_edit');
$security->delete('vagas/delete/{id}', 'Security\VagasType::delete')->bind('s_vagas_type_delete');
